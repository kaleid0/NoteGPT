...
export function SyncProvider({ children, serverUrl, token }: SyncProviderProps) {
  ...
  const syncEvents: SyncEvents = useMemo(
    ...
    [
      ...
      removeNoteFromStore,
      setLastRemoteUpdate,
      setLastUpdatedNoteId,
      setLastDeletedNoteId,
      setStatus,
    ]
  )
  ...
  const { status, clientId, connect, disconnect, sendUpdate, sendCreate, sendDelete } = useSync(
    syncEvents,
    syncOptions
  )
  ...
  const contextValue: SyncContextType = useMemo(
    () => ({
      ...
      lastUpdatedNote: lastUpdatedNoteIdFromStore
        ? useNotesStore.getState().notesById[lastUpdatedNoteIdFromStore] ?? null
        : null,
    ...
    [
      ...
      syncCreate,
      syncDelete,
      lastRemoteUpdateFromStore,
      lastUpdatedNoteIdFromStore,
      lastDeletedNoteIdFromStore,
    ]
  )
