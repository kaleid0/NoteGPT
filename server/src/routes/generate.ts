  ...
  fastify.post(
    ...
    async (request: FastifyRequest<{ Body: GenerateRequestBody }>, reply: FastifyReply) => {
      ...
      try {
        ...
        try {
          ;(await import('../services/audit')).logEvent('generate.request', { input })
        } catch (_e) {
          /* ignore */
        }
        ...
        if (!apiKey && !requestApiKey) {
          ...
          try {
            ;(await import('../services/audit')).logEvent('generate.complete', {
              input,
              mock: true,
        ...
        try {
          ;(await import('../services/audit')).logEvent('generate.error', {
            input,
            error: errorMessage,
          })
        } catch (_e) {
